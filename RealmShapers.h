...
public:
    ...
    void inOrderTraversalRec(int index, std::vector<std::string> &result);

    std::vector<std::string> preOrderTraversal(int index);

    void preOrderTraversalRec(int index, std::vector<std::string> &result);

    std::vector<std::string> postOrderTraversal(int index);

    void postOrderTraversalRec(int index, std::vector<std::string> &result);

    void breadthFirstTraversal(std::ofstream &outFile);

    void deleteLastIsle(int index,Isle *isle);
